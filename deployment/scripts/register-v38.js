/**
 * register-v38.js — Register UHF v3.8 (The Tensor Amplitude & Microcausality Update) on Polygon Mainnet
 */
...
async function main() {
    ...
    const expectedHash = "c359ed151b2a2893187ac49630ba71341511b83daffbf2d4af1aa9931c26792b";
    ...
    console.log("Registering v3.8 on UHFPaperRegistry...");
    const tx = await contract.registerPaper(hash, "Amir Benjamin Amitay", "3.8");
    ...
    console.log("\n" + "=".repeat(70));
    console.log("SUCCESS — UHF v3.8 REGISTERED ON POLYGON MAINNET");
    ...
    deployment["v3.8"] = {
        version: "3.8",
        title: "The Tensor Amplitude & Microcausality Update",
        hash, txHash: tx.hash,

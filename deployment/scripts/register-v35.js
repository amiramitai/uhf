/**
 * register-v35.js — Register UHF v3.5 (The Relativistic Core & Entropy Update) on Polygon Mainnet
 */
...
async function main() {
    ...
    const expectedHash = "0056545f5654056ed196c035949ee5d94fdd3a451aa3a4571906c654bf47a144";
    ...
    console.log("Registering v3.5 on UHFPaperRegistry...");
    const tx = await contract.registerPaper(hash, "Amir Benjamin Amitay", "3.5");
    ...
    console.log("\n" + "=".repeat(70));
    console.log("SUCCESS — UHF v3.5 REGISTERED ON POLYGON MAINNET");
    ...
    deployment["v3.5"] = {
        version: "3.5",
        title: "The Relativistic Core & Entropy Update",
        hash, txHash: tx.hash,

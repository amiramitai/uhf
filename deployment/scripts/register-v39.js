/**
 * register-v39.js — Register UHF v3.9 (The Non-Perturbative Stability Update) on Polygon Mainnet
 */
...
async function main() {
    ...
    const expectedHash = "061bcd54af06c9cb4fa3cf9ea083cbf2ace7c6efe17abe8763f7f244673be597";
    ...
    console.log("Registering v3.9 on UHFPaperRegistry...");
    const tx = await contract.registerPaper(hash, "Amir Benjamin Amitay", "3.9");
    ...
    console.log("\n" + "=".repeat(70));
    console.log("SUCCESS — UHF v3.9 REGISTERED ON POLYGON MAINNET");
    ...
    deployment["v3.9"] = {
        version: "3.9",
        title: "The Non-Perturbative Stability Update",
        hash, txHash: tx.hash,

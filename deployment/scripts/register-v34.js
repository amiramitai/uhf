/**
 * register-v34.js — Register UHF v3.4 (The Quantum-Horizon Update) on Polygon Mainnet
 */
...
async function main() {
    ...
    const expectedHash = "e29acbdd0877741d11eeb2aa31a68ad3f4bc4c28a60aef93fa54629feb5dbcc0";
    ...
    console.log("Registering v3.4 on UHFPaperRegistry...");
    const tx = await contract.registerPaper(hash, "Amir Benjamin Amitay", "3.4");
    ...
    // --- Output ---
    console.log("\n" + "=".repeat(70));
    console.log("SUCCESS — UHF v3.4 REGISTERED ON POLYGON MAINNET");
    ...
    deployment["v3.4"] = {
        version: "3.4",
        title: "The Quantum-Horizon Update",
        hash: hash,
        txHash: tx.hash,

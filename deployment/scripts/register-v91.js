/**
 * register-v91.js — UHF Paper Registry v9.1
 *
 * v9.1 (March 18, 2026) — Journal-Safe Rhetorical Overhaul (Part I only):
 *   • Abstract: Rewritten for journal submission (EFT framing, falsifiable GW signatures)
 *   • Introduction: "EFT of the Vacuum" replaces "Crisis of Foundations"
 *   • §4–7: "Pillar I–IV" → "Hydrodynamic Correspondence I–IV"
 *   • §5.3: "Deriving G" → "Constitutive Consistency Relation"
 *   • §5.5: "Derivation" → "Linearized Isomorphism and Effective Backreaction"
 *   • §6.1: Polite Volovik-citing isomorphism language
 *   • §7.5: "Elimination of Spacetime" → "Spacetime as Emergent Effective Geometry"
 *
 * Parts II & III unchanged from v9.0.
 *
...
const PAPERS = [
    {
        ...
        version: "9.1-Part-I",
        label: "UHF Part I — Physical Core (Journal-Safe Overhaul)",
...
async function main() {
    ...
    console.log("\n" + "=".repeat(70));
    console.log("SUCCESS — UHF v9.1 (ALL 3 PARTS) REGISTERED ON POLYGON MAINNET");
